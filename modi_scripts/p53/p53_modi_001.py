...
if __name__ == "__main__":
    ...
    coupling_strengths, _ = np.split(np.linspace(0.001, 5, antal_A_ext), 2)
    ...
    save_data(arnold_dict_parallel, f'arnold/p53_no_chaos_001_{antal_omegaer}by{antal_A_ext}.pkl.gz')