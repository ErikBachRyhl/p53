...
if __name__ == "__main__":
    ...
    _, _, coupling_strengths = np.split(np.linspace(0.001, 3.8, antal_A_ext), 3)
    ...
    save_data(arnold_dict_parallel, f'arnold/3_nfkb_{antal_omegaer}by{antal_A_ext}.pkl.gz')