...
if __name__ == "__main__":
    ...
    _, coupling_strengths, _ = np.split(np.linspace(0.001, 10, antal_A_ext), 3)  
    ...
    save_data(arnold_dict_parallel, f'arnold/2_p53_chaos_{antal_omegaer}by{antal_A_ext}.pkl.gz')